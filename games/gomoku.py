...
class MuZeroConfig:
    def __init__(self):
        ...
        self.training_steps = 10  # Total number of training steps (ie weights update according to a batch) ?10000
        self.batch_size = 512  # Number of parts of games to train on at each training step
        self.checkpoint_interval = 1  # Number of training steps before using the model for self-playing      ?50
